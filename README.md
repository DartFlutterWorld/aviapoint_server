...
# Проверка логов сервера (для диагностики проблем)
./check_server_logs.sh

# Синхронизация файлов миграций на прод (если ошибка "Файл миграции не найден")
./sync_migrations_to_prod.sh

# Синхронизация структуры БД и папки public на прод
# См. документацию:
# - SYNC_SCHEMA.md - синхронизация структуры БД
# - SYNC_PUBLIC_STRUCTURE.md - синхронизация структуры папки public