...
CREATE INDEX IF NOT EXISTS idx_aircraft_manufacturers_active ON aircraft_manufacturers(is_active);
...
CREATE INDEX IF NOT EXISTS idx_aircraft_market_is_active ON aircraft_market(is_active);
