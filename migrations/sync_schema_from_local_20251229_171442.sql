...
\restrict uwNPZYXOeGai2oTjXh3qrI607WTF6i3A4DuWO0lhwkG2fFaNCeGltaV7oatQMH7
...
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_subscription_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_reviewer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_reviewed_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_reply_to_review_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_booking_id_fkey;
ALTER TABLE IF EXISTS ONLY public.question_type_certificates DROP CONSTRAINT IF EXISTS question_type_certificates_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.preflight_inspection_check_list DROP CONSTRAINT IF EXISTS "preflight_inspetion_check_lis_preflihgtInspectionCategoryI_fkey";
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.preflight_inspection_categories DROP CONSTRAINT IF EXISTS "hand_book_sub_categories_mainCategoryId_fkey";
ALTER TABLE IF EXISTS ONLY public.flights DROP CONSTRAINT IF EXISTS flights_pilot_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_waypoints DROP CONSTRAINT IF EXISTS flight_waypoints_flight_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_questions DROP CONSTRAINT IF EXISTS flight_questions_flight_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_questions DROP CONSTRAINT IF EXISTS flight_questions_author_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_questions DROP CONSTRAINT IF EXISTS flight_questions_answered_by_id_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_photos DROP CONSTRAINT IF EXISTS flight_photos_uploaded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.flight_photos DROP CONSTRAINT IF EXISTS flight_photos_flight_id_fkey;
ALTER TABLE IF EXISTS ONLY public.question_type_certificates DROP CONSTRAINT IF EXISTS fk_question_type_certificates_type;
ALTER TABLE IF EXISTS ONLY public.question_type_certificates DROP CONSTRAINT IF EXISTS fk_question_type_certificates_question;
ALTER TABLE IF EXISTS ONLY public.airport_visitor_photos DROP CONSTRAINT IF EXISTS fk_airport_visitor_photos_user;
ALTER TABLE IF EXISTS ONLY public.airport_visitor_photos DROP CONSTRAINT IF EXISTS fk_airport_visitor_photos_airport;
ALTER TABLE IF EXISTS ONLY public.feedback DROP CONSTRAINT IF EXISTS feedback_flight_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_passenger_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_flight_id_fkey;
ALTER TABLE IF EXISTS ONLY public.airports DROP CONSTRAINT IF EXISTS airports_owner_id_fkey;
ALTER TABLE IF EXISTS ONLY public.airport_ownership_requests DROP CONSTRAINT IF EXISTS airport_ownership_requests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.airport_ownership_requests DROP CONSTRAINT IF EXISTS airport_ownership_requests_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.airport_ownership_requests DROP CONSTRAINT IF EXISTS airport_ownership_requests_airport_id_fkey;
DROP TRIGGER IF EXISTS update_subscriptions_updated_at ON public.subscriptions;
DROP TRIGGER IF EXISTS update_flights_updated_at ON public.flights;
DROP TRIGGER IF EXISTS update_flight_questions_updated_at ON public.flight_questions;
DROP TRIGGER IF EXISTS update_bookings_updated_at ON public.bookings;
DROP TRIGGER IF EXISTS update_airports_updated_at ON public.airports;
DROP INDEX IF EXISTS public."preflight_inspetion_check_list_preflihgtInspectionCategoryId";
DROP INDEX IF EXISTS public.normal_check_list_normal_category_id;
DROP INDEX IF EXISTS public.normal_categories_main_category_id;
DROP INDEX IF EXISTS public.idx_subscriptions_user_id;
DROP INDEX IF EXISTS public.idx_subscriptions_payment_id;
DROP INDEX IF EXISTS public.idx_subscriptions_is_active;
DROP INDEX IF EXISTS public.idx_subscriptions_end_date;
DROP INDEX IF EXISTS public.idx_reviews_reviewed_id;
DROP INDEX IF EXISTS public.idx_reviews_reply_to_review_id;
DROP INDEX IF EXISTS public.idx_reviews_booking_id;
DROP INDEX IF EXISTS public.idx_profiles_owned_airports;
DROP INDEX IF EXISTS public.idx_payments_user_id;
DROP INDEX IF EXISTS public.idx_payments_subscription_type;
DROP INDEX IF EXISTS public.idx_payments_status;
DROP INDEX IF EXISTS public.idx_payments_period_days;
DROP INDEX IF EXISTS public.idx_payments_created_at;
DROP INDEX IF EXISTS public.idx_flights_status;
DROP INDEX IF EXISTS public.idx_flights_pilot_id;
DROP INDEX IF EXISTS public.idx_flights_departure_date;
DROP INDEX IF EXISTS public.idx_flight_waypoints_sequence;
DROP INDEX IF EXISTS public.idx_flight_waypoints_flight_id;
DROP INDEX IF EXISTS public.idx_flight_waypoints_airport_code;
DROP INDEX IF EXISTS public.idx_flight_questions_flight_id;
DROP INDEX IF EXISTS public.idx_flight_questions_created_at;
DROP INDEX IF EXISTS public.idx_flight_questions_author_id;
DROP INDEX IF EXISTS public.idx_flight_questions_answered_by_id;
DROP INDEX IF EXISTS public.idx_flight_photos_uploaded_by;
DROP INDEX IF EXISTS public.idx_flight_photos_flight_id;
DROP INDEX IF EXISTS public.idx_feedback_status;
DROP INDEX IF EXISTS public.idx_feedback_source_page;
DROP INDEX IF EXISTS public.idx_feedback_flight_id;
DROP INDEX IF EXISTS public.idx_feedback_created_at;
DROP INDEX IF EXISTS public.idx_feedback_airport_code;
DROP INDEX IF EXISTS public.idx_bookings_status;
DROP INDEX IF EXISTS public.idx_bookings_passenger_id;
DROP INDEX IF EXISTS public.idx_bookings_flight_id;
DROP INDEX IF EXISTS public.idx_airports_type;
DROP INDEX IF EXISTS public.idx_airports_region;
DROP INDEX IF EXISTS public.idx_airports_photos;
DROP INDEX IF EXISTS public.idx_airports_name;
DROP INDEX IF EXISTS public.idx_airports_location;
DROP INDEX IF EXISTS public.idx_airports_is_active;
DROP INDEX IF EXISTS public.idx_airports_ident_ru;
DROP INDEX IF EXISTS public.idx_airports_ident;
DROP INDEX IF EXISTS public.idx_airports_country_code;
DROP INDEX IF EXISTS public.idx_airports_city;
DROP INDEX IF EXISTS public.idx_airport_visitor_photos_user_id;
DROP INDEX IF EXISTS public.idx_airport_visitor_photos_uploaded_at;
DROP INDEX IF EXISTS public.idx_airport_visitor_photos_airport_id;
DROP INDEX IF EXISTS public.idx_airport_visitor_photos_airport_code;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_user_id;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_user_airport;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_status;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_created_at;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_airport_id;
DROP INDEX IF EXISTS public.idx_airport_ownership_requests_airport_code;
DROP INDEX IF EXISTS public.idx_airport_feedback_status;
DROP INDEX IF EXISTS public.idx_airport_feedback_created_at;
DROP INDEX IF EXISTS public.idx_airport_feedback_airport_code;
DROP INDEX IF EXISTS public."hand_book_sub_categories_mainCategoryId";
ALTER TABLE IF EXISTS ONLY public.video DROP CONSTRAINT IF EXISTS video_id;
ALTER TABLE IF EXISTS ONLY public.flight_waypoints DROP CONSTRAINT IF EXISTS uq_flight_waypoints_sequence;
ALTER TABLE IF EXISTS ONLY public.airport_visitor_photos DROP CONSTRAINT IF EXISTS uq_airport_visitor_photos_airport_code_url;
ALTER TABLE IF EXISTS ONLY public.type_certificates DROP CONSTRAINT IF EXISTS type_certificates_pkey;
ALTER TABLE IF EXISTS ONLY public.subscriptions DROP CONSTRAINT IF EXISTS subscriptions_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_types DROP CONSTRAINT IF EXISTS subscription_types_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_types DROP CONSTRAINT IF EXISTS subscription_types_code_key;
ALTER TABLE IF EXISTS ONLY public.stories DROP CONSTRAINT IF EXISTS stories_pkey;
ALTER TABLE IF EXISTS ONLY public.rosaviatest_questions DROP CONSTRAINT IF EXISTS rosaviatest_questions_pkey;
ALTER TABLE IF EXISTS ONLY public.rosaviatest_category DROP CONSTRAINT IF EXISTS rosaviatest_question_category_pkey;
ALTER TABLE IF EXISTS ONLY public.rosaviatest_answers DROP CONSTRAINT IF EXISTS rosaviatest_answers_pkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.preflight_inspection_categories DROP CONSTRAINT IF EXISTS preflight_inspection_categories_id;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_pkey;
ALTER TABLE IF EXISTS ONLY public.hand_book_main_categories DROP CONSTRAINT IF EXISTS "hand_book_main_categories_mainCategoryId";
ALTER TABLE IF EXISTS ONLY public.flights DROP CONSTRAINT IF EXISTS flights_pkey;
ALTER TABLE IF EXISTS ONLY public.flight_waypoints DROP CONSTRAINT IF EXISTS flight_waypoints_pkey;
ALTER TABLE IF EXISTS ONLY public.flight_questions DROP CONSTRAINT IF EXISTS flight_questions_pkey;
ALTER TABLE IF EXISTS ONLY public.flight_photos DROP CONSTRAINT IF EXISTS flight_photos_pkey;
...
ALTER TABLE IF EXISTS ONLY public.airports DROP CONSTRAINT IF EXISTS airports_ident_key;
ALTER TABLE IF EXISTS ONLY public.airport_visitor_photos DROP CONSTRAINT IF EXISTS airport_visitor_photos_pkey;
ALTER TABLE IF EXISTS ONLY public.airport_ownership_requests DROP CONSTRAINT IF EXISTS airport_ownership_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.airport_feedback DROP CONSTRAINT IF EXISTS airport_feedback_pkey;
ALTER TABLE IF EXISTS public.type_certificates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subscriptions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subscription_types ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.stories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rosaviatest_category ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.rosaviatest_answers ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.preflight_inspection_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.flights ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.flight_waypoints ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.flight_questions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.flight_photos ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.airport_visitor_photos ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.airport_ownership_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.airport_feedback ALTER COLUMN id DROP DEFAULT;
DROP TABLE IF EXISTS CASCADE public.video;
DROP TABLE IF EXISTS CASCADE public.type_correct_answers;
DROP SEQUENCE IF EXISTS public.type_certificates_id_seq;
DROP TABLE IF EXISTS CASCADE public.type_certificates;
DROP SEQUENCE IF EXISTS public.subscriptions_id_seq;
DROP TABLE IF EXISTS CASCADE public.subscriptions;
DROP SEQUENCE IF EXISTS public.subscription_types_id_seq;
DROP TABLE IF EXISTS CASCADE public.subscription_types;
DROP TABLE IF EXISTS CASCADE public.rosaviatest_type_certificates_category;
DROP TABLE IF EXISTS CASCADE public.rosaviatest_questions;
DROP SEQUENCE IF EXISTS public.rosaviatest_question_category_id_seq;
DROP TABLE IF EXISTS CASCADE public.rosaviatest_category;
DROP SEQUENCE IF EXISTS public.rosaviatest_answers_id_seq;
DROP TABLE IF EXISTS CASCADE public.rosaviatest_answers;
DROP SEQUENCE IF EXISTS public.reviews_id_seq;
DROP TABLE IF EXISTS CASCADE public.reviews;
DROP TABLE IF EXISTS CASCADE public.question_type_certificates;
DROP SEQUENCE IF EXISTS public.profiles_id_seq;
DROP TABLE IF EXISTS CASCADE public.profiles;
DROP TABLE IF EXISTS CASCADE public.preflight_inspection_check_list;
DROP SEQUENCE IF EXISTS public.preflight_inspection_categories_id_seq;
DROP TABLE IF EXISTS CASCADE public.preflight_inspection_categories;
DROP TABLE IF EXISTS CASCADE public.payments;
DROP TABLE IF EXISTS CASCADE public.normal_check_list;
DROP TABLE IF EXISTS CASCADE public.normal_categories;
DROP TABLE IF EXISTS CASCADE public.news;
DROP SEQUENCE IF EXISTS public.mini_stories_id_seq;
DROP TABLE IF EXISTS CASCADE public.stories;
DROP TABLE IF EXISTS CASCADE public.hand_book_main_categories;
DROP SEQUENCE IF EXISTS public.flights_id_seq;
DROP TABLE IF EXISTS CASCADE public.flights;
DROP SEQUENCE IF EXISTS public.flight_waypoints_id_seq;
DROP TABLE IF EXISTS CASCADE public.flight_waypoints;
DROP SEQUENCE IF EXISTS public.flight_questions_id_seq;
DROP TABLE IF EXISTS CASCADE public.flight_questions;
DROP SEQUENCE IF EXISTS public.flight_photos_id_seq;
DROP TABLE IF EXISTS CASCADE public.flight_photos;
DROP SEQUENCE IF EXISTS public.feedback_id_seq;
DROP TABLE IF EXISTS CASCADE public.feedback;
DROP TABLE IF EXISTS CASCADE public.emergency_categories;
DROP TABLE IF EXISTS CASCADE public.category_news;
DROP SEQUENCE IF EXISTS public.bookings_id_seq;
DROP TABLE IF EXISTS CASCADE public.bookings;
DROP TABLE IF EXISTS CASCADE public.airspeeds_for_emergency_operations;
DROP SEQUENCE IF EXISTS public.airports_id_seq;
DROP TABLE IF EXISTS CASCADE public.airports;
DROP SEQUENCE IF EXISTS public.airport_visitor_photos_id_seq;
DROP TABLE IF EXISTS CASCADE public.airport_visitor_photos;
DROP SEQUENCE IF EXISTS public.airport_ownership_requests_id_seq;
DROP TABLE IF EXISTS CASCADE public.airport_ownership_requests;
DROP SEQUENCE IF EXISTS public.airport_feedback_id_seq;
DROP TABLE IF EXISTS CASCADE public.airport_feedback;
...
\unrestrict uwNPZYXOeGai2oTjXh3qrI607WTF6i3A4DuWO0lhwkG2fFaNCeGltaV7oatQMH7
